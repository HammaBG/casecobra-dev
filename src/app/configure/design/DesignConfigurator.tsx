                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent>
                                            {MODELS.options.map((model) => (
                                                <DropdownMenuItem key={model.label} className={cn("flex text-sm gap-1 item-center p-1.5 cursor-default hover:bg-zinc-100", { 'bg-zinc-100': model.label === options.model.label }
                                    ...
                                    <RadioGroup key={name} value={options[name]} onChange={(val) => {
                                        ...
                                        <div className="mt-3 space-y-4">
                                            {selectableOptions.map((option)=>(
                                                ...
                                                className={({active,checked})=>cn("relative block bg-white cursor-pointer rounded-lg px-4 py-6 shadow-sm border-2 border-zinc-200 focus:outline-none ring-0 focus:ring-0 outline-none sm:flex sm:justify-between",{
